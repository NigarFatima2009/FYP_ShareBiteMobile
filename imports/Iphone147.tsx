import svgPaths from "./svg-82ojahilhh";

function Group1() {
  return (
    <div className="absolute h-[200px] left-[22px] top-[-59px] w-[346px]">
...
function Group() {
  return (
    <div className="absolute h-[196px] left-[44px] top-[720px] w-[302px]">
...
export default function Iphone() {
  return (
    <div className="bg-white relative size-full" data-name="Iphone 14 - 7">
      <div className="absolute bg-[rgba(244,101,230,0.78)] h-[750px] left-[119px] rounded-[34px] top-[52px] w-[162px]" />
      <Group1 />
      <Group />
    </div>
  );
